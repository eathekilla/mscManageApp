...
export class MagicianComponent implements OnInit {
  ...
  sortByName() {
    this.aux = this.aux.sort((a, b) => a.name.localeCompare(b.name))
  }
  sortByLastName() {
